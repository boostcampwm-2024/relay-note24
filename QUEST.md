...
- 선택 퀘스트 1: 동료들에게 받은 피드백을 하루 1개 정리해보자.
    ...
    - 수행 후기: 이번 주차 미션이 자연스럽게 피드백을 받고 개선을 하는 거다 보니까. 미션이 해결되어 버렸습니다.<br> 확실히 여러 사람들의 의견을 듣고 개선 작업을 하다 보니 프로그램이 저만의 관점이 아니라 다른 사람들의 관점도 수용할 수 있는 탄탄한 프로그램이 되는 거 같습니다!
- 선택 퀘스트 2: 함수나 클래스에 설명 doc 주석 달기
    - 선정 이유: 평소에 하려고 노력하고 있지만, 조금 더 잘 하고 싶어서.
    - 수행 후기:<br>
    <img width="801" alt="image" src="https://github.com/user-attachments/assets/f2d56921-73e0-4942-980d-bf3917ca4fb2"><br>
